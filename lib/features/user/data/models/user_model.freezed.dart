...
@override
String toString() {
  return 'UserResponseModel(id: $id, username: $username, email: $email, firstName: $firstName, lastName: $lastName)';
}
...
switch (_that) {
case _UserResponseModel():
return $default(_that.id,_that.username,_that.email,_that.firstName,_that.lastName);}
}
...
class _UserResponseModel extends UserResponseModel {
  const _UserResponseModel({required this.id, required this.username, required this.email, required this.firstName, required this.lastName}): super._();
